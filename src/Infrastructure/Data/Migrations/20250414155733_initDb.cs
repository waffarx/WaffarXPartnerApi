        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HashKey = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    ClientApiId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamPageActions", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamPageActions_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamPageActions_Users_CreatedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamPageAction_CreatedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamPageAction_TeamId",
                table: "TeamPageActions",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "UQ_TeamPageAction_TeamId_PageId",
                table: "TeamPageActions",
                columns: new[] { "TeamId", "PageId" },
                unique: true);
